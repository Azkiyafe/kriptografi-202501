...
2. Menghitung unicity distance untuk ciphertext tertentu
3. Menganalisis kekuatan kunci berdasarkan entropi dan unicity distance
4. Mengevaluasi potensi serangan brute force pada kriptosistem sederhana
...
1. Entropy ruang kunci 26 = 4.7004397181410926 bit
2. Entropy ruang kunci 2^128 = 128.0 bit
3. Unicity Distance untuk Caesar Cipher = 1.3286821202813005
4. Waktu brute force Caesar Cipher (26 kunci) = 3.0092592592592594e-05 hari
5. Waktu brute force AES-128 = 3.938453319713727e+32 hari
...
```
commit abc12345
Author: Azkiya Fe Sabella <azkiyafesabella14@gmail.coom>
Date:   2025-09-20

    week4-entropy-unicity: implementasi perhitungan entropy , unicity, dan analisis )
```
